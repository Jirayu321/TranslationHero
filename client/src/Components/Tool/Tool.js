              ...
              <div className="BoxSunEditor">
                <div className="ToolHaed4">
                  <div className="ToolInHaed4">
                    ...
                    <p className="ToolInHaed4text2">/ Article</p>
                  </div>
                ...
                <div className="ToolHaed3">
                  <div className="ToolHaed2">
                    <div>
                      <p className="TextHTool">Article</p>
                    </div>
                    <p>Timeline : 2023/8/29 </p>
                    <p>Detail : - </p>
                    <p>File: 1.jpeg</p>
                  </div>
                  <div>
                    <button className="ToolbuttonOpenFile">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
