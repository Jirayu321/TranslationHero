              ...
              <ListItem button key={text} id={"button_manu_Translate"}>
                {index === 0 ? (
                  ...
                  >
                    ...
                    >
                      <path
                        d="M7.5495 0.529934C8.3874 -0.176646 9.6126 -0.176646 10.4505 0.529944L17.2005 6.22204C17.7074 6.64956 18 7.27894 18 7.9421V17.2519C18 18.2184 17.2165 19.0019 16.25 19.0019H12.75C11.7835 19.0019 11 18.2184 11 17.2519V12.2448C11 12.1068 10.8881 11.9948 10.75 11.9948H7.25C7.1119 11.9948 6.99999 12.1068 6.99999 12.2448V17.2519C6.99999 18.2184 6.2165 19.0019 5.25 19.0019H1.75C0.7835 19.0019 0 18.2184 0 17.2519V7.9421C0 7.27894 0.29255 6.64956 0.79952 6.22204L7.5495 0.529934ZM9.4835 1.67664C9.2042 1.44111 8.7958 1.44111 8.5165 1.67664L1.76651 7.36875C1.59752 7.51125 1.5 7.72105 1.5 7.9421V17.2519C1.5 17.39 1.61193 17.5019 1.75 17.5019H5.25C5.38807 17.5019 5.49999 17.39 5.49999 17.2519V12.2448C5.49999 11.2783 6.2835 10.4948 7.25 10.4948H10.75C11.7165 10.4948 12.5 11.2783 12.5 12.2448V17.2519C12.5 17.39 12.6119 17.5019 12.75 17.5019H16.25C16.3881 17.5019 16.5 17.39 16.5 17.2519V7.9421C16.5 7.72105 16.4025 7.51125 16.2335 7.36875L9.4835 1.67664Z"
                        fill="white"
                      />
                    </svg>
                  ...
                  <ListItemIcon
                    // id={nameAC === "" ? "icons_translate2" : "icons_translate"}
                    id={"icons_translate2"}
                    onClick={() =>
                      navigate("/Tool", {
                        state: {
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        stroke="url(#paint0_linear_2834_7153)"
                        stroke-width="2"
