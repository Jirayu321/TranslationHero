          ...
          {type === 1 ? (
            ...
            <>
              ...
              <p className={styles.textHeading2_overviwe3_5}>
                ...
                เรียกว่า ทนายรับรองเอกสาร ทนายความรับรองลายมือชื่อ หรือ Notarial
                Services Attorney เพื่อให้สามารถนำเอกสารดังกล่าว
            ...
            <>
              ...
              <p className={styles.textHeading2_overviwe3}>
                ...
                เพื่อประกอบการทำธุรกรรมต่างๆ เช่น การขอวีซ่า (Visa Application)
                ต่อวีซ่า (Visa Extension) สมัครงาน สมัครเรียน สมรส
                ขอมีถิ่นที่อยู่ ขอรับบุตรบุญธรรม เป็นต้น
              </p>
            </>
          )}
        </div>
                ...
                <div className={styles.Boxfram3_3}>
                  <div>
                    ...
                    <p className={styles.HBoxdetaile3_3}>
                      ...
                      ภาษาเยอรมัน ฝรั่งเศส สถานเอกอัครราชทูตฯ เจ้าของภาษาจะเป็น
                      ผู้แปลภาษาอังกฤษหรือภาษาไทย และรับรองคำแปลนั้น ทั้งนี้
                      กระทรวงฯ จะรับรองคำแปลเฉพาะที่แปลจากเอกสารต้นฉบับที่
                ...
                <div className={styles.Boxfram3_3}>
                  <div>
                    ...
                    <p className={styles.HBoxdetaile3_3}>
                      ...
                      ต้องมีเอกสารต้นฉบับพร้อมถ่ายสำเนาอีก 1 ชุด หากต้องมากกว่า
          ...
          <div className={styles.fram3_6}>
            <div className={styles.detailefram3_6}>
              <div className={styles.Indetailefram3_6}>
                <p className={styles.H_Indetailefram3_6}>ขอบข่ายการให้บริการ</p>
