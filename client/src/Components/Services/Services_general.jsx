              ...
              <div className={styles.fram3_7}>
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesTH.at(154)?.label}
                      </p>
                      {/* <p className={styles.HBoxdetaile3_1}>Translation Service</p> */}
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesTH.at(155)?.label}
                      </p>
                    </div>
                    <div className={styles.Imggeneral1} />
                  </div>
                ...
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    ...
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesTH.at(156)?.label}
                      </p>
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesTH.at(157)?.label}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesTH.at(158)?.label}
                      </p>
                      {/* <p className={styles.HBoxdetaile3_1}>Translation Service</p> */}
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesTH.at(159)?.label}
                      </p>
                    </div>
                    <div className={styles.Imggeneral3} />
                  </div>
                ...
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    ...
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesTH.at(160)?.label}
                      </p>
                      {/* <p className={styles.HBoxdetaile3_1}>Service</p> */}
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesTH.at(161)?.label}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesTH.at(162)?.label}
                      </p>
                      {/* <p className={styles.HBoxdetaile3_1}>Localization Service</p> */}
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesTH.at(163)?.label}
                      </p>
                    </div>
                    <div className={styles.Imggeneral5} />
                  </div>
              ...
              <div className={styles.fram3_7}>
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesDE.at(154)?.label}
                      </p>
                      {/* <p className={styles.HBoxdetaile3_1}>Translation Service</p> */}
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesDE.at(155)?.label}
                      </p>
                    </div>
                    <div className={styles.Imggeneral1} />
                  </div>
                ...
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    ...
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesDE.at(156)?.label}
                      </p>
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesDE.at(157)?.label}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesDE.at(158)?.label}
                      </p>
                      {/* <p className={styles.HBoxdetaile3_1}>Translation Service</p> */}
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesDE.at(159)?.label}
                      </p>
                    </div>
                    <div className={styles.Imggeneral3} />
                  </div>
                ...
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    ...
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesDE.at(160)?.label}
                      </p>
                      {/* <p className={styles.HBoxdetaile3_1}>Service</p> */}
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesDE.at(161)?.label}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.detailefram_general}>
                  <div className={styles.Boxfram3_3}>
                    <div>
                      <p className={styles.HBoxdetaile3_1}>
                        {ServicesDE.at(162)?.label}
                      </p>
                      {/* <p className={styles.HBoxdetaile3_1}>Localization Service</p> */}
                      <p className={styles.HBoxdetaile_general}>
                        {ServicesDE.at(163)?.label}
                      </p>
                    </div>
                    <div className={styles.Imggeneral5} />
                  </div>
